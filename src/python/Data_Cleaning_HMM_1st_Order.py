...
def finalize_typo_prob(alpha = 1):
    global typo_prob
    typo_prob = []
    for c1 in range(26):
        typo_prob.append([])
...
def finalize_transition_prob(alpha = 1):
...
rate = 1
prep()
train_file = "../../data/train_correct.txt"
train_typo_file = "../../data/train_typo.txt"
